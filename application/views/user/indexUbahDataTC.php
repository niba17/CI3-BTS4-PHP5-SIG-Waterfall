...
<div class="container-fluid" id="isi">
    ...
    <div class="d-sm-flex align-items-center justify-content-between">
        <h3 class="mb-0 text-gray-800">Ubah Toko Cinderamata</h3>
    </div>
    <!-- <?php print_r($detailTCById); ?> -->
    <hr class="divider">
    <a class="btn btn-<?= $customColor; ?> btn-sm"
        href="<?= base_url($key . '/indexDetailTC' . $key . '/' . $detailTCById->id) ?>">
    ...
    <form class="user mt-3" enctype="multipart/form-data" id="inputFormTambah"
        action="<?= base_url('Admin/ubahDataTC'); ?>" method="post">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <input type="hidden" name="FUinputId" value="<?= $detailTCById->id; ?>" method="post">
                <div class="form-group mb-3">
                    <label for="FUinputNamaTC">Nama Toko Cinderamata</label>
                    <input type="text" class="form-control" name="FUinputNamaTC" id="FUinputNamaTC"
                        value="<?= $detailTCById->nmusaha; ?>" required>
                </div>
                <div class="form-group mb-3">
                    ...
                    <select class="custom-select" name="FUinputKecamatan" id="FUinputKecamatan" required>
                        ...
                        <?php if ($rowKec->nama == $detailTCById->namaKecamatan) : ?>
                        <option value=<?= $detailTCById->idkecamatan; ?> selected><?= $detailTCById->namaKecamatan; ?>
                        </option>
                        <?php endif; ?>
                        <?php if ($rowKec->nama != $detailTCById->namaKecamatan) : ?>
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="custom-select" name="FUinputKelurahan" id="FUinputKelurahan" required>
                        <option value="<?= $detailTCById->idkelurahan; ?>" selected>
                            <?= $detailTCById->namaKelurahan . ' (selected)'; ?></option>
                    </select>
                </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="FUinputNamaPemilik" name="FUinputNamaPemilik"
                        value="<?= $detailTCById->nmpemilik; ?>" required>
                </div>
            </div>
        </div>
