...
Swal.fire({
    icon: 'error',
    title: 'Data Toko Cinderamata sudah ada!',
...
<div class="container-fluid" id="isi">
    ...
    <div class="d-sm-flex align-items-center justify-content-between">
        <h3 class="mb-0 text-gray-800">Index Tambah Data Toko Cinderamata</h3>
    </div>
    ...
    <form class="user mt-3" enctype="multipart/form-data" id="inputFormTambah"
        action="<?= base_url('Admin/tambahDataTC/') . $sidebarTitle; ?>" method="post">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="form-group mb-3">
                    <label for="FTinputNamaTC">Nama Toko Cinderamata</label>
                    <input type="text" class="form-control" name="FTinputNamaTC" id="FTinputNamaTC"
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <!-- <a class="btn btn-<?= $customColor; ?>" href="<?= base_url('Admin/indexDetailTCAdmin/') . $id . '/' . $sidebarTitle ?>"><i class="fa-solid fa-circle-left"></i> Kembali</a> -->
    </form>
</div>
<script>
