...
<div class="container-fluid" id="isi">
    ...
    <div class="d-sm-flex align-items-center justify-content-between">
        <h3 class="mb-0 text-gray-800">Index Tambah Data BPP</h3>
    </div>

    <!-- Divider -->
    <hr class="divider">

    <a class="btn btn-<?= $customColor; ?> btn-sm" href="<?= base_url('Admin/indexBPPAdmin'); ?>">
        <i class="fa-solid fa-circle-left"></i>
        <span>Kembali</span>
    </a>

    <form class="user mt-3" enctype="multipart/form-data" id="inputFormTambah"
        action="<?= base_url('Admin/tambahDataBPP/') . $sidebarTitle; ?>" method="post">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="form-group mb-3">
                    <label for="FTinputNamaBPP">Nama Objek Biro Perjalanan Pariwisata</label>
                    <input type="text" class="form-control" name="FTinputNamaBPP" id="FTinputNamaBPP"
                        placeholder="Masukkan Nama BPP..." required>
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">
                    <label for="FTinputLink">Link Biro Perjalanan Pariwisata</label>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <!-- <a class="btn btn-<?= $customColor; ?>" href="<?= base_url('Admin/indexDetailBPPAdmin/') . $id . '/' . $sidebarTitle ?>"><i class="fa-solid fa-circle-left"></i> Kembali</a> -->
