<div class="container-fluid" id="isi">
    ...
    <div class="d-sm-flex align-items-center justify-content-between">
        <h3 class="mb-0 text-gray-800">Detail data Biro Pengurus Pariwisata</h1>
    </div>

    <!-- Divider -->
    <hr class="divider">
    <a class="btn btn-<?= $customColor; ?> btn-sm" href="<?= base_url($key . '/indexBPP' . $key); ?>">
    ...
    <div class="table-responsive mt-3">
        ...
        foreach ($semua["dataBPP"] as $rowBPP) : ?>
                <tr class="even">
                    ...
                    <td><?= $rowBPP->namaKecamatan; ?></td>
                    <td><?= $rowBPP->namaKelurahan; ?></td>
                    <td><?= $rowBPP->alamat; ?></td>
                    <td><?= $rowBPP->nmpemilik; ?></td>
                    <td><?= $rowBPP->notdup; ?></td>
                    <td><a href="<?= 'http://'.$rowBPP->link; ?>"><?= $rowBPP->link; ?></a></td>
                    <?php if ($this->session->userdata('username')) : ?>
                    <td>
                        <a class="btn btn-<?= $customColor; ?> btn-sm btn-circle"
                            href="<?= base_url('Admin/indexUbahDataBPP/') . $rowBPP->id ?>">
                            <i class="fa-solid fa-pen-to-square"></i>
                        </a>
                        <a class="btn btn-<?= $customColor; ?> btn-sm btn-circle" href="#"
                            onclick="hapus('<?= $rowBPP->id; ?>','tabelbpp','<?= $sidebarTitle; ?>')">
